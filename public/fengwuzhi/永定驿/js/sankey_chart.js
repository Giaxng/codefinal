(function () {
    function initSankeyChart() {
        ...
        const nodes = [
            ...
            { name: '丘陵潮湿环境', depth: 0, x: 0.7 },
            { name: '厚实夯土墙体保温', depth: 1, x: 0.3 },
            { name: '天井采光增温', depth: 1, x: 0.3 },
            { name: '杉木结构保温', depth: 1, x: 0.3 },
            { name: '夯土墙体呼吸调湿', depth: 1, x: 0.3 }
        ];
        const links = [
            { source: '丘陵潮湿环境', target: '厚实夯土墙体保温', value: 30 },
            { source: '冬季寒冷', target: '天井采光增温', value: 25 },
            { source: '丘陵潮湿环境', target: '杉木结构保温', value: 20 },
            { source: '冬季寒冷', target: '夯土墙体呼吸调湿', value: 20 }
        ];
        const colors = {
            '冬季寒冷': '#4f7de0',
            '丘陵潮湿环境': '#58c8d2',
    ...
    function getNodeDescription(nodeName) {
        const descriptions = {
            '冬季寒冷': '苏州地区冬季寒冷的气候特点',
            '丘陵潮湿环境': '苏州地区丘陵潮湿环境的环境特征',
            '厚实夯土墙体保温': '檐口和檐廊出挑设计，防止雨水飘入',
            '天井采光增温': '望砖青瓦形成空气夹层，防潮保温',
            '杉木结构保温': '屋面坡度和滴水瓦设计，有效排水',
            '夯土墙体呼吸调湿': '通透布局减少湿气滞留，保持室内干燥'
        };
