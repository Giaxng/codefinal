(function () {
    function initSankeyChart() {
        ...
        const nodes = [
            { name: '岭南多雨', depth: 0, x: 0.7 },
            { name: '高温', depth: 0, x: 0.7 },
            { name: '台风', depth: 0, x: 0.7 },
            { name: '镬耳墙防火', depth: 1, x: 0.3 },
            { name: '坡屋顶排水', depth: 1, x: 0.3 },
            { name: '高墙窄巷', depth: 1, x: 0.3 }
        ];
        const links = [
            { source: '岭南多雨', target: '坡屋顶排水', value: 30 },
            { source: '高温', target: '高墙窄巷', value: 25 },
            { source: '台风', target: '高墙窄巷', value: 20 },
            { source: '高温', target: '镬耳墙防火', value: 15 }
        ];
        const colors = {
            '岭南多雨': '#4f7de0',
            '高温': '#58c8d2',
    ...
    function getNodeDescription(nodeName) {
        ...
        return descriptions[nodeName] || '镬耳屋构造要素';
    }
