(function () {
    function initSankeyChart() {
        ...
        const nodes = [
            { name: '干旱', depth: 0, x: 0.7 },
            { name: '风沙', depth: 0, x: 0.7 },
            { name: '高温', depth: 0, x: 0.7 },
            { name: '高台聚居', depth: 1, x: 0.3 },
            { name: '厚墙', depth: 1, x: 0.3 },
            { name: '小窗', depth: 1, x: 0.3 },
            { name: '平顶', depth: 1, x: 0.3 }
        ];
        const links = [
            { source: '干旱', target: '平顶', value: 30 },
            { source: '风沙', target: '厚墙', value: 25 },
            { source: '风沙', target: '小窗', value: 20 },
            { source: '高温', target: '厚墙', value: 20 }
        ];
        const colors = {
            '干旱': '#4f7de0',
            '风沙': '#58c8d2',
    ...
    function getNodeDescription(nodeName) {
        ...
        return descriptions[nodeName] || '高台民居构造要素';
    }
