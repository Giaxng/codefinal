(function () {
    function initSankeyChart() {
        ...
        const nodes = [
            { name: '干旱炎热', depth: 0, x: 0.7 },
            { name: '风沙', depth: 0, x: 0.7 },
            { name: '采光', depth: 0, x: 0.7 },
            { name: '封闭庭院', depth: 1, x: 0.3 },
            { name: '天窗采光', depth: 1, x: 0.3 },
            { name: '厚墙', depth: 1, x: 0.3 },
            { name: '平顶', depth: 1, x: 0.3 }
        ];
        const links = [
            { source: '干旱炎热', target: '厚墙', value: 30 },
            { source: '干旱炎热', target: '平顶', value: 25 },
            { source: '风沙', target: '封闭庭院', value: 25 },
            { source: '采光', target: '天窗采光', value: 20 }
        ];
        const colors = {
            '干旱炎热': '#4f7de0',
            '风沙': '#58c8d2',
    ...
    function getNodeDescription(nodeName) {
        ...
        return descriptions[nodeName] || '新疆阿以旺构造要素';
    }
