            ...
            series: [
                {
                    ...
                    markPoint: {
                        data: [
                            { name: '65', value: 65, xAxis: 19, yAxis: 65, symbolSize: 8, itemStyle: { color: '#ff6b6b' } }
                        ],
                        symbol: 'circle',
                        symbolSize: 8,
                        label: {
                    ...
                    data: [33, 29, 10, 7, 8, 6, 6, 19, 34, 31, 42, 41, 47, 44, 34, 41, 44, 28, 48, 65, 47, 65, 42, 48]
                }
            ]
        };
        myChart.setOption(option);
    ...
    function echarts_8() {
        ...
        option = {
            ...
            xAxis: [{
                    ...
                    data: [
                        '土掌房', '城子村', '云南省', '传统民居', '彝族民居', '城子古村', '泸西县', '石屏县', '双柏县', '永宁乡',
                        '栗树村', '美学视域', '乡土建筑', '文化内涵', '瓦板房', '彝族土掌房', '传统民居建筑', '慕善村', '云南彝族', '红河州'
                    ]
                }],
            yAxis: [{
                    type: 'value',
            ...
            series: [{
                    ...
                    type: 'bar',
                    barWidth: '60%',
                    data: [47, 7, 7, 6, 5, 5, 4, 3, 3, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2],
                    itemStyle: {
                        normal: {
                            color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [
