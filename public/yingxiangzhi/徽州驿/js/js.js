                    ...
                    textStyle: {
                        ...
                        color: function (params) {
                            ...
                            if (value > 100) {
                                ...
                                var colorIndex = charCode % lowFrequencyColors.length;
                                return lowFrequencyColors[colorIndex];
                            }
                        }
                    },
                    emphasis: {
            ...
            series: [
                {
                    ...
                    markPoint: {
                        data: [
                            { name: '41', value: 41, xAxis: 22, yAxis: 41, symbolSize: 8, itemStyle: { color: '#ff6b6b' } }
                        ],
                        symbol: 'circle',
                        symbolSize: 8,
                        label: {
                    ...
                    data: [31, 14, 15, 9, 0, 1, 8, 10, 15, 13, 34, 20, 28, 26, 19, 21, 18, 23, 31, 26, 32, 27, 41, 34]
                }
            ]
        };
        myChart.setOption(option);
    ...
    function echarts_8() {
        ...
        option = {
            ...
            xAxis: [{
                    ...
                    data: [
                        '徽派民居', '徽派建筑', '传统民居', '徽派古民居', '民居建筑',
                        '古民居', '徽州古民居', '徽州民居', '徽州古民居建筑', '徽派古建筑',
                        '现代建筑', '马头墙', '平利县', '古村落', '装饰艺术',
                        '建筑设计', '建筑风格', '徽州传统民居', '古民居建筑', '传统村落'
                    ]
                }],
            yAxis: [{
                    type: 'value',
            ...
            series: [{
                    ...
                    type: 'bar',
                    barWidth: '60%',
                    data: [92, 64, 23, 19, 18, 17, 15, 14, 7, 7, 6, 5, 5, 5, 4, 4, 4, 4, 4, 4],
                    itemStyle: {
                        normal: {
                            color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [
