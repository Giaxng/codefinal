    ...
    function echarts_5() {
        ...
        try {
            ...
            container.innerHTML = '<div style="color: white; padding: 20px; text-align: center;">' +
                ...
                '<span style="font-size: 30px; color: #ff3333;">苏州(249)</span>' +
                '<span style="font-size: 24px; color: #ff704d;">园林(106)</span>' +
                '<span style="font-size: 20px; color: #3399ff;">建筑(69)</span>' +
                '<span style="font-size: 18px; color: #ff9900;">喜欢(68)</span>' +
                '<span style="font-size: 16px; color: #006633;">可以(58)</span>' +
                '</div></div>';
        }
    }
    function echarts_4() {
            ...
            series: [
                {
                    ...
                    markPoint: {
                        data: [
                            { name: '93', value: 93, xAxis: 22, yAxis: 93, symbolSize: 8, itemStyle: { color: '#ff6b6b' } }
                        ],
                        symbol: 'circle',
                        symbolSize: 8,
                        label: {
                    ...
                    data: [51, 33, 14, 7, 5, 8, 12, 18, 38, 40, 43, 48, 65, 61, 49, 56, 74, 49, 73, 72, 48, 71, 93, 74]
                }
            ]
        };
        myChart.setOption(option);
    ...
    function echarts_8() {
        ...
        option = {
            ...
            xAxis: [{
                    ...
                    data: [
                        '传统民居', '古民居', '民居建筑', '苏州古城', '建筑装饰',
                        '比较研究', '传统民居建筑', '苏州传统民居', '庭院空间', '苏州地区',
                        '民居改造', '香山帮', '策略研究', '保护与更新', '空间形态',
                        '保护和利用', '民居空间', '类型学', '江南民居', '地域文化'
                    ]
                }],
            yAxis: [{
                    type: 'value',
            ...
            series: [{
                    ...
                    type: 'bar',
                    barWidth: '60%',
                    data: [53, 26, 18, 10, 9, 8, 8, 7, 6, 5, 4, 4, 4, 4, 4, 4, 3, 3, 3, 3],
                    itemStyle: {
                        normal: {
                            color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [
