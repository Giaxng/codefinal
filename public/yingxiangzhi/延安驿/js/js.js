    ...
    function echarts_5() {
        ...
        try {
            ...
            container.innerHTML = '<div style="color: white; padding: 20px; text-align: center;">' +
                ...
                '<span style="font-size: 30px; color: #ff3333;">窑洞(136)</span>' +
                '<span style="font-size: 24px; color: #ff704d;">地坑院(46)</span>' +
                '<span style="font-size: 20px; color: #3399ff;">黄土(45)</span>' +
                '<span style="font-size: 18px; color: #ff9900;">陕北(22)</span>' +
                '<span style="font-size: 16px; color: #006633;">冬暖夏凉(18)</span>' +
                '</div></div>';
        }
    }
    function echarts_4() {
            ...
            series: [
                {
                    ...
                    markPoint: {
                        data: [
                            { name: '67', value: 67, xAxis: 23, yAxis: 67, symbolSize: 8, itemStyle: { color: '#ff6b6b' } }
                        ],
                        symbol: 'circle',
                        symbolSize: 8,
                        label: {
                    ...
                    data: [49, 11, 5, 5, 3, 2, 1, 8, 12, 44, 37, 46, 45, 42, 15, 24, 29, 44, 46, 49, 55, 58, 64, 67]
                }
            ]
        };
        myChart.setOption(option);
    ...
    function echarts_8() {
        ...
        option = {
            ...
            xAxis: [{
                    ...
                    data: [
                        '窑洞民居', '传统民居', '传统村落', '陕北窑洞', '黄土高原',
                        '窑洞建筑', '黄土窑洞', '生土建筑', '延安窑洞', '民居建筑',
                        '地坑院', '毛泽东', '设计研究', '窑洞对', '空间形态',
                        '土窑洞', '山西省', '地域文化', '策略研究', '窑洞文化'
                    ]
                }],
            yAxis: [{
                    type: 'value',
            ...
            series: [{
                    ...
                    type: 'bar',
                    barWidth: '60%',
                    data: [135, 130, 125, 102, 82, 67, 61, 53, 53, 51, 48, 43, 42, 40, 35, 35, 34, 32, 29, 27],
                    itemStyle: {
                        normal: {
                            color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [
