    ...
    function echarts_5() {
        ...
        try {
            ...
            container.innerHTML = '<div style="color: white; padding: 20px; text-align: center;">' +
                ...
                '<span style="font-size: 30px; color: #cc0000;">建筑(18)</span>' +
                '<span style="font-size: 25px; color: #0066cc;">骑楼(17)</span>' +
                '<span style="font-size: 23px; color: #006633;">新疆(15)</span>' +
                '<span style="font-size: 23px; color: #006633;">窑洞(15)</span>' +
                '<span style="font-size: 21px; color: #663399;">阿凡提(14)</span>' +
                '</div></div>';
        }
    }
    function echarts_4() {
            ...
            series: [
                {
                    ...
                    markPoint: {
                        data: [
                            { name: '28', value: 28, xAxis: 17, yAxis: 28, symbolSize: 8, itemStyle: { color: '#ff6b6b' } }
                        ],
                        symbol: 'circle',
                        symbolSize: 8,
                        label: {
                    ...
                    data: [11, 6, 2, 2, 2, 1, 2, 4, 5, 8, 11, 11, 21, 13, 9, 7, 11, 28, 18, 16, 22, 22, 17, 13]
                }
            ]
        };
        myChart.setOption(option);
    ...
    function echarts_8() {
        ...
        option = {
            ...
            xAxis: [{
                    ...
                    data: [
                        '高台民居', '喀什市', '喀什高台民居', '民居建筑', '维吾尔族',
                        '新疆喀什', '传统民居', '历史文化街区', '风貌保护', '风景油画',
                        '《高台民居》', '地域性', '老城区', '喀什老城', '数字化保护',
                        '喀什噶尔', '适应性研究', '场所精神', '建筑研究', '空间形态'
                    ]
                }],
            yAxis: [{
                    type: 'value',
            ...
            series: [{
                    ...
                    type: 'bar',
                    barWidth: '60%',
                    data: [79, 13, 11, 9, 8, 7, 6, 5, 3, 3, 3, 3, 3, 3, 3, 2, 2, 2, 2, 2],
                    itemStyle: {
                        normal: {
                            color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [
