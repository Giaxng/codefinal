                    ...
                    textStyle: {
                        ...
                        color: function (params) {
                            ...
                            if (value > 100) {
                                ...
                                var lowFrequencyColors = ['#ff6600', '#006666', '#008000'];
                                var index = params.dataIndex % lowFrequencyColors.length;
                                return lowFrequencyColors[index];
                            }
                        }
                    },
                    emphasis: {
            ...
            series: [
                {
                    ...
                    markPoint: {
                        data: [
                            { name: '63', value: 63, xAxis: 21, yAxis: 63, symbolSize: 8, itemStyle: { color: '#ff6b6b' } }
                        ],
                        symbol: 'circle',
                        symbolSize: 8,
                        label: {
                    ...
                    data: [24, 14, 10, 3, 1, 4, 6, 3, 8, 13, 16, 26, 45, 22, 21, 15, 19, 41, 19, 42, 27, 63, 38, 37]
                }
            ]
        };
        myChart.setOption(option);
    ...
    function echarts_8() {
        ...
        option = {
            ...
            xAxis: [{
                    ...
                    data: [
                        '吊脚楼', '凤凰古城', '土家族', '沈从文', '湘西土家族',
                        '传统民居', '土家族吊脚楼', '土家吊脚楼', '凤凰城', '《湘西吊脚楼》',
                        '湘西凤凰', '湘西民居', '湘西地区', '传统建筑', '《吊脚楼下的湘西》',
                        '湘西州', '民族建筑', '沈从文故居', '建筑特征', '张家界'
                    ]
                }],
            yAxis: [{
                    type: 'value',
            ...
            series: [{
                    ...
                    type: 'bar',
                    barWidth: '60%',
                    data: [122, 28, 27, 20, 10, 8, 6, 6, 5, 5, 5, 4, 4, 4, 4, 3, 3, 3, 3, 3],
                    itemStyle: {
                        normal: {
                            color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [
