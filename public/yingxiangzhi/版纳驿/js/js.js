            ...
            series: [{
                    ...
                    textStyle: {
                        ...
                        color: function (params) {
                            ...
                            var colorIndex = Math.abs(hash) % 10;
                            var brighterColors = [
                                '#3399ff',
                                '#ff5722',
                                '#00e676',
                            ...
                            var baseColor = brighterColors[colorIndex];
                            return baseColor;
                        }
                    },
                    emphasis: {
            ...
            series: [
                {
                    ...
                    markPoint: {
                        data: [
                            { name: '48', value: 48, xAxis: 12, yAxis: 48, symbolSize: 8, itemStyle: { color: '#ff6b6b' } }
                        ],
                        symbol: 'circle',
                        symbolSize: 8,
                        label: {
                    ...
                    data: [22, 20, 10, 8, 3, 2, 8, 7, 13, 25, 29, 45, 48, 35, 22, 27, 34, 20, 22, 26, 40, 37, 35, 41]
                }
            ]
        };
        myChart.setOption(option);
    ...
    function echarts_8() {
        ...
        option = {
            ...
            xAxis: [{
                    ...
                    data: [
                        '竹楼', '西双版纳', '傣族民居', '传统民居', '傣家竹楼',
                        '傣族竹楼', '《黄冈竹楼记》', '《黄州新建小竹楼记》', '基诺族', '民居建筑',
                        '王禹偁', '《竹楼琴声》', '凤尾竹', '竹文化', '中国传统民居',
                        '教学设计', '傣族村寨', '我爱我家', '竹建筑', '云南省'
                    ]
                }],
            yAxis: [{
                    type: 'value',
            ...
            series: [{
                    ...
                    type: 'bar',
                    barWidth: '60%',
                    data: [39, 16, 15, 14, 12, 12, 11, 10, 9, 8, 8, 7, 6, 5, 5, 5, 5, 5, 5, 5],
                    itemStyle: {
                        normal: {
                            color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [
