            ...
            series: [
                {
                    ...
                    markPoint: {
                        data: [
                            { name: '81', value: 81, xAxis: 18, yAxis: 81, symbolSize: 8, itemStyle: { color: '#ff6b6b' } }
                        ],
                        symbol: 'circle',
                        symbolSize: 8,
                        label: {
                    ...
                    data: [25, 25, 8, 11, 6, 3, 4, 5, 11, 11, 13, 21, 19, 20, 14, 17, 23, 69, 81, 56, 42, 43, 45, 35]
                }
            ]
        };
        myChart.setOption(option);
    ...
    function echarts_8() {
        ...
        option = {
            ...
            xAxis: [{
                    ...
                    data: [
                        '阿以旺', '传统民居', '阿以旺民居', '维吾尔族民居', '维吾尔族',
                        '和田地区', '半室外空间', '营造技艺', '新疆和田地区', '维吾尔',
                        '气候适应性', '民居建筑', '维吾尔民居', '传统民居建筑', '有机建筑',
                        '烟囱效应', '生土民居', '竞赛方案', '伊斯兰', '建筑艺术'
                    ]
                }],
            yAxis: [{
                    type: 'value',
            ...
            series: [{
                    ...
                    type: 'bar',
                    barWidth: '60%',
                    data: [14, 12, 7, 5, 5, 3, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 1, 1, 1],
                    itemStyle: {
                        normal: {
                            color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [
