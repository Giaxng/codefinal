    ...
    function echarts_5() {
        ...
        try {
            ...
            container.innerHTML = '<div style="color: white; padding: 20px; text-align: center;">' +
                ...
                '<span style="font-size: 30px; color: #2f89cf;">蒙古包(178)</span>' +
                ...
                '<span style="font-size: 14px; color: #9d96f5;">草原(34)</span>' +
                '</div></div>';
        }
    }
    function echarts_4() {
            ...
            series: [
                {
                    ...
                    markPoint: {
                        data: [
                            { name: '56', value: 56, xAxis: 18, yAxis: 56, symbolSize: 8, itemStyle: { color: '#ff6b6b' } }
                        ],
                        symbol: 'circle',
                        symbolSize: 8,
                        label: {
                    ...
                    data: [26, 25, 12, 15, 5, 12, 10, 14, 23, 22, 36, 26, 41, 21, 32, 53, 35, 30, 56, 38, 35, 37, 41, 41]
                }
            ]
        };
        myChart.setOption(option);
    ...
    function echarts_8() {
        ...
        option = {
            ...
            xAxis: [{
                    ...
                    data: [
                        '蒙古包', '内蒙古', '蒙古族', '游牧民族', '内蒙古草原',
                        '传统蒙古包', '蒙古包建筑', '乌兰巴托', '室内设计', '设计研究',
                        '文化符号', '翻译实践报告', '传统民居', '地域文化', '文创产品',
                        '非物质文化遗产', '内蒙古地区', '民俗文化', '蒙古包营造技艺', '住居文化'
                    ]
                }],
            yAxis: [{
                    type: 'value',
            ...
            series: [{
                    ...
                    type: 'bar',
                    barWidth: '60%',
                    data: [147, 59, 55, 16, 12, 11, 11, 10, 10, 9, 9, 9, 8, 8, 8, 8, 7, 7, 6, 6],
                    itemStyle: {
                        normal: {
                            color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [
