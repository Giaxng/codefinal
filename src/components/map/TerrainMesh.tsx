...
void main() {
  ...
  vec3 fresnelColor = vec3(0.8, 0.9, 0.9);
...
export function TerrainMesh({ size = 20, resolution = 128 }: TerrainMeshProps) {
    ...
    const shaderMaterial = useMemo(() => {
        return new THREE.ShaderMaterial({
            ...
            fragmentShader,
            uniforms: {
                uColorWater: { value: new THREE.Color("#112F41") },
                uColorLow: { value: new THREE.Color("#104E3E") },
                uColorMid: { value: new THREE.Color("#407D5C") },
                uColorHigh: { value: new THREE.Color("#8FB996") },
                uColorPeak: { value: new THREE.Color("#C4A484") },
            },
            transparent: true,
    ...
    return (<mesh ref={meshRef} geometry={geometry} material={shaderMaterial} receiveShadow castShadow/>);
}
