...
export default function RootLayout({ children, }: Readonly<{
    ...
    return (<html lang="zh-CN" suppressHydrationWarning>
      <body className={`${notoSerif.variable} ${notoSans.variable} ${jetbrainsMono.variable} antialiased`} style={{ fontFamily: 'var(--font-sans), "Noto Sans SC", system-ui, sans-serif' }}>
        {children}
      </body>
    </html>);
}
